...
?>
    ...
    <div class="main">
        ...
        <a href="CaliforniaClubChickenWraps.php"><img src="CaliforniaClubChickenWraps" height="200" width="200" class="img"></a>
        <?php
